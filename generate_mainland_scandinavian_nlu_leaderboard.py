"""Python script to generate the Mainland Scandinavian NLU leaderboard."""
...
def main() -> None:
    ...
    benchmark_path = Path("mainland-scandinavian-nlu-benchmark.md")
    ...
    # Log status
    logging.info(
        "Generated Mainland Scandinavian NLU benchmark with results from "
