...
<center>Last updated: 29/05/2024 12:22:39 CET</center>
...
<table id="norwegian-nlg" class="sortable fixed centered small-font">
 ...
 <tbody>
  ...
  <tr class="not-merged-model">
   ...
   <td class="no sent">28.09 ± 3.72 / 30.47 ± 3.52</td> <!-- NoReC -->
   <td class="no summ">63.60 ± 0.15 / 13.15 ± 0.35</td> <!-- No Sammendrag -->
   <td class="no la">61.67 ± 5.17 / 79.72 ± 2.72</td> <!-- ScaLA-nb -->
   <td class="no la">55.97 ± 4.50 / 75.16 ± 3.48</td> <!-- ScaLA-nn -->
   <td class="no qa">44.67 ± 3.23 / 73.39 ± 1.83</td> <!-- NorQuAD -->
   <td class="no know">66.92 ± 1.75 / 75.04 ± 1.33</td> <!-- MMLU-no -->
   <td class="no reason">83.96 ± 1.45 / 87.77 ± 1.10</td> <!-- HellaSwag-no -->
  ...
  <tr class="not-merged-model">
   ...
   <td class="no sent">46.78 ± 8.00 / 61.61 ± 6.57</td> <!-- NoReC -->
   <td class="no summ">63.25 ± 0.26 / 13.02 ± 0.33</td> <!-- No Sammendrag -->
   <td class="no la">35.42 ± 9.62 / 55.42 ± 7.67</td> <!-- ScaLA-nb -->
   <td class="no la">24.28 ± 6.66 / 49.09 ± 4.99</td> <!-- ScaLA-nn -->
   <td class="no qa">43.51 ± 3.40 / 74.52 ± 1.79</td> <!-- NorQuAD -->
   <td class="no know">57.71 ± 5.56 / 67.03 ± 4.55</td> <!-- MMLU-no -->
   <td class="no reason">80.77 ± 4.05 / 85.16 ± 3.33</td> <!-- HellaSwag-no -->
   <td>12.10.0</td> <!-- NorNE-nb version -->
   <td>12.10.0</td> <!-- NorNE-nn version -->
   <td>12.10.0</td> <!-- NoReC version -->
   <td>12.10.0</td> <!-- No Sammendrag version -->
