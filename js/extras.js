...
var rows = document.getElementById('pretrained-leaderboard').getElementsByTagName('tr')
...
// can fill in all the aggregated score columns
var rows = document.getElementById('finetuned-leaderboard').getElementsByTagName('tr')
var languages = ['da', 'no', 'sv', 'is', 'fo']
