...
<center>Last updated: 20/12/2023 14:31:18</center>
...
<table id="mainland-scandinavian-nlu-benchmark" class="sortable fixed centered small-font">
 ...
 <tbody>
  <tr>
   ...
   <td class="no ner">84.38 ± 0.81 / 88.43 ± 0.78</td> <!-- NorNE-nb -->
   <td class="no ner">84.38 ± 0.81 / 88.43 ± 0.78</td> <!-- NorNE-nn -->
   <td class="no sent">60.84 ± 1.48 / 72.16 ± 1.38</td> <!-- NoReC -->
   <td class="no la">72.10 ± 2.07 / 85.37 ± 1.33</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">78.66 ± 1.85 / 82.99 ± 1.53</td> <!-- NorNE-nb -->
   <td class="no ner">78.66 ± 1.85 / 82.99 ± 1.53</td> <!-- NorNE-nn -->
   <td class="no sent">57.37 ± 1.31 / 70.45 ± 1.13</td> <!-- NoReC -->
   <td class="no la">70.05 ± 1.76 / 84.13 ± 1.17</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">77.41 ± 1.57 / 81.41 ± 1.46</td> <!-- NorNE-nb -->
   <td class="no ner">77.41 ± 1.57 / 81.41 ± 1.46</td> <!-- NorNE-nn -->
   <td class="no sent">48.34 ± 2.10 / 60.68 ± 3.61</td> <!-- NoReC -->
   <td class="no la">37.46 ± 2.69 / 67.68 ± 1.66</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">79.06 ± 1.70 / 83.08 ± 1.50</td> <!-- NorNE-nb -->
   <td class="no ner">79.06 ± 1.70 / 83.08 ± 1.50</td> <!-- NorNE-nn -->
   <td class="no sent">35.34 ± 1.88 / 48.31 ± 2.28</td> <!-- NoReC -->
   <td class="no la">36.12 ± 8.59 / 66.98 ± 4.91</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">79.36 ± 1.38 / 83.08 ± 1.22</td> <!-- NorNE-nb -->
   <td class="no ner">79.36 ± 1.38 / 83.08 ± 1.22</td> <!-- NorNE-nn -->
   <td class="no sent">35.87 ± 1.85 / 48.94 ± 3.37</td> <!-- NoReC -->
   <td class="no la">39.55 ± 7.01 / 68.65 ± 3.36</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">79.18 ± 1.45 / 83.10 ± 1.12</td> <!-- NorNE-nb -->
   <td class="no ner">79.18 ± 1.45 / 83.10 ± 1.12</td> <!-- NorNE-nn -->
   <td class="no sent">36.21 ± 1.82 / 49.48 ± 2.69</td> <!-- NoReC -->
   <td class="no la">39.82 ± 2.81 / 68.68 ± 1.81</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">79.27 ± 1.21 / 83.09 ± 1.06</td> <!-- NorNE-nb -->
   <td class="no ner">79.27 ± 1.21 / 83.09 ± 1.06</td> <!-- NorNE-nn -->
   <td class="no sent">35.16 ± 1.75 / 48.41 ± 2.71</td> <!-- NoReC -->
   <td class="no la">32.94 ± 5.88 / 64.36 ± 4.59</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.62 ± 1.92 / 79.57 ± 1.49</td> <!-- NorNE-nb -->
   <td class="no ner">74.62 ± 1.92 / 79.57 ± 1.49</td> <!-- NorNE-nn -->
   <td class="no sent">40.15 ± 1.15 / 46.26 ± 0.47</td> <!-- NoReC -->
   <td class="no la">63.77 ± 1.27 / 81.62 ± 0.65</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.00 ± 2.01 / 79.67 ± 1.62</td> <!-- NorNE-nb -->
   <td class="no ner">76.00 ± 2.01 / 79.67 ± 1.62</td> <!-- NorNE-nn -->
   <td class="no sent">38.70 ± 2.53 / 50.88 ± 3.38</td> <!-- NoReC -->
   <td class="no la">24.13 ± 6.88 / 60.76 ± 3.29</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">73.67 ± 2.26 / 77.22 ± 1.99</td> <!-- NorNE-nb -->
   <td class="no ner">73.67 ± 2.26 / 77.22 ± 1.99</td> <!-- NorNE-nn -->
   <td class="no sent">37.02 ± 1.09 / 47.88 ± 2.50</td> <!-- NoReC -->
   <td class="no la">6.87 ± 6.85 / 50.70 ± 3.62</td> <!-- ScaLA-nb -->
   <td class="no la">6.87 ± 6.85 / 50.70 ± 3.62</td> <!-- ScaLA-nn -->
   <td class="no qa">28.66 ± 1.83 / 32.79 ± 1.96</td> <!-- ScandiQA-no -->
  ...
  <tr>
   ...
   <td class="no ner">82.86 ± 1.29 / 86.19 ± 0.97</td> <!-- NorNE-nb -->
   <td class="no ner">82.86 ± 1.29 / 86.19 ± 0.97</td> <!-- NorNE-nn -->
   <td class="no sent">50.25 ± 15.36 / 63.55 ± 13.05</td> <!-- NoReC -->
   <td class="no la">43.89 ± 14.81 / 68.88 ± 10.32</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">83.46 ± 1.68 / 86.81 ± 1.35</td> <!-- NorNE-nb -->
   <td class="no ner">83.46 ± 1.68 / 86.81 ± 1.35</td> <!-- NorNE-nn -->
   <td class="no sent">53.69 ± 4.28 / 63.69 ± 6.95</td> <!-- NoReC -->
   <td class="no la">61.21 ± 1.20 / 79.87 ± 0.76</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">81.57 ± 1.30 / 85.21 ± 1.05</td> <!-- NorNE-nb -->
   <td class="no ner">81.57 ± 1.30 / 85.21 ± 1.05</td> <!-- NorNE-nn -->
   <td class="no sent">54.26 ± 1.75 / 67.25 ± 1.47</td> <!-- NoReC -->
   <td class="no la">49.30 ± 1.39 / 74.02 ± 1.04</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.61 ± 1.34 / 79.47 ± 1.14</td> <!-- NorNE-nb -->
   <td class="no ner">75.61 ± 1.34 / 79.47 ± 1.14</td> <!-- NorNE-nn -->
   <td class="no sent">39.53 ± 0.99 / 50.90 ± 2.17</td> <!-- NoReC -->
   <td class="no la">23.56 ± 2.23 / 60.05 ± 1.05</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.84 ± 1.18 / 77.97 ± 1.09</td> <!-- NorNE-nb -->
   <td class="no ner">74.84 ± 1.18 / 77.97 ± 1.09</td> <!-- NorNE-nn -->
   <td class="no sent">38.44 ± 1.67 / 52.60 ± 1.95</td> <!-- NoReC -->
   <td class="no la">23.10 ± 3.66 / 58.14 ± 3.65</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.25 ± 1.62 / 77.98 ± 1.36</td> <!-- NorNE-nb -->
   <td class="no ner">74.25 ± 1.62 / 77.98 ± 1.36</td> <!-- NorNE-nn -->
   <td class="no sent">39.15 ± 3.29 / 53.00 ± 3.85</td> <!-- NoReC -->
   <td class="no la">17.10 ± 3.43 / 57.00 ± 1.86</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.86 ± 1.50 / 78.92 ± 1.42</td> <!-- NorNE-nb -->
   <td class="no ner">74.86 ± 1.50 / 78.92 ± 1.42</td> <!-- NorNE-nn -->
   <td class="no sent">36.27 ± 1.57 / 50.95 ± 1.70</td> <!-- NoReC -->
   <td class="no la">29.81 ± 3.52 / 64.03 ± 2.35</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">71.63 ± 1.31 / 75.39 ± 1.03</td> <!-- NorNE-nb -->
   <td class="no ner">71.63 ± 1.31 / 75.39 ± 1.03</td> <!-- NorNE-nn -->
   <td class="no sent">36.56 ± 3.06 / 51.25 ± 3.01</td> <!-- NoReC -->
   <td class="no la">19.72 ± 3.67 / 56.70 ± 2.89</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.55 ± 1.69 / 79.16 ± 1.50</td> <!-- NorNE-nb -->
   <td class="no ner">75.55 ± 1.69 / 79.16 ± 1.50</td> <!-- NorNE-nn -->
   <td class="no sent">33.94 ± 3.74 / 47.96 ± 4.12</td> <!-- NoReC -->
   <td class="no la">4.16 ± 2.97 / 50.07 ± 2.09</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">71.00 ± 1.64 / 75.00 ± 1.28</td> <!-- NorNE-nb -->
   <td class="no ner">71.00 ± 1.64 / 75.00 ± 1.28</td> <!-- NorNE-nn -->
   <td class="no sent">33.88 ± 1.40 / 49.21 ± 1.98</td> <!-- NoReC -->
   <td class="no la">18.18 ± 2.65 / 57.28 ± 1.84</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da qa">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- ScandiQA-da -->
   <td class="no ner">62.61 ± 1.22 / 67.14 ± 1.18</td> <!-- NorNE-nb -->
   <td class="no ner">62.61 ± 1.22 / 67.14 ± 1.18</td> <!-- NorNE-nn -->
   <td class="no sent">29.00 ± 1.28 / 41.72 ± 0.52</td> <!-- NoReC -->
   <td class="no la">21.79 ± 1.60 / 60.32 ± 0.99</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">55.12 ± 1.67 / 58.73 ± 1.81</td> <!-- NorNE-nb -->
   <td class="no ner">55.12 ± 1.67 / 58.73 ± 1.81</td> <!-- NorNE-nn -->
   <td class="no sent">40.65 ± 1.63 / 55.20 ± 2.63</td> <!-- NoReC -->
   <td class="no la">12.95 ± 3.01 / 55.31 ± 1.87</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">48.14 ± 1.95 / 51.44 ± 2.28</td> <!-- NorNE-nb -->
   <td class="no ner">48.14 ± 1.95 / 51.44 ± 2.28</td> <!-- NorNE-nn -->
   <td class="no sent">33.41 ± 1.40 / 45.12 ± 1.87</td> <!-- NoReC -->
   <td class="no la">20.09 ± 1.88 / 59.27 ± 1.08</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">70.26 ± 2.24 / 74.59 ± 1.98</td> <!-- NorNE-nb -->
   <td class="no ner">70.26 ± 2.24 / 74.59 ± 1.98</td> <!-- NorNE-nn -->
   <td class="no sent">52.16 ± 0.99 / 66.79 ± 0.98</td> <!-- NoReC -->
   <td class="no la">14.21 ± 6.44 / 52.78 ± 5.69</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">78.65 ± 2.01 / 82.66 ± 1.64</td> <!-- NorNE-nb -->
   <td class="no ner">78.65 ± 2.01 / 82.66 ± 1.64</td> <!-- NorNE-nn -->
   <td class="no sent">32.73 ± 1.37 / 46.52 ± 1.86</td> <!-- NoReC -->
   <td class="no la">30.37 ± 5.50 / 62.12 ± 5.66</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.61 ± 0.81 / 80.69 ± 0.69</td> <!-- NorNE-nb -->
   <td class="no ner">76.61 ± 0.81 / 80.69 ± 0.69</td> <!-- NorNE-nn -->
   <td class="no sent">33.16 ± 2.13 / 46.93 ± 2.66</td> <!-- NoReC -->
   <td class="no la">30.10 ± 2.50 / 64.29 ± 1.69</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.08 ± 1.06 / 80.29 ± 1.02</td> <!-- NorNE-nb -->
   <td class="no ner">76.08 ± 1.06 / 80.29 ± 1.02</td> <!-- NorNE-nn -->
   <td class="no sent">33.19 ± 1.75 / 46.63 ± 2.55</td> <!-- NoReC -->
   <td class="no la">24.97 ± 6.47 / 61.39 ± 3.34</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.64 ± 1.40 / 78.83 ± 1.18</td> <!-- NorNE-nb -->
   <td class="no ner">74.64 ± 1.40 / 78.83 ± 1.18</td> <!-- NorNE-nn -->
   <td class="no sent">30.70 ± 2.63 / 43.77 ± 2.62</td> <!-- NoReC -->
   <td class="no la">27.20 ± 2.61 / 62.87 ± 1.41</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.31 ± 1.19 / 79.59 ± 0.97</td> <!-- NorNE-nb -->
   <td class="no ner">75.31 ± 1.19 / 79.59 ± 0.97</td> <!-- NorNE-nn -->
   <td class="no sent">29.37 ± 2.58 / 44.05 ± 3.33</td> <!-- NoReC -->
   <td class="no la">24.06 ± 7.24 / 61.01 ± 3.82</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">82.40 ± 1.16 / 85.65 ± 0.96</td> <!-- NorNE-nb -->
   <td class="no ner">82.40 ± 1.16 / 85.65 ± 0.96</td> <!-- NorNE-nn -->
   <td class="no sent">54.46 ± 1.16 / 68.25 ± 0.76</td> <!-- NoReC -->
   <td class="no la">8.99 ± 2.25 / 48.57 ± 3.67</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.10 ± 1.23 / 80.23 ± 1.09</td> <!-- NorNE-nb -->
   <td class="no ner">76.10 ± 1.23 / 80.23 ± 1.09</td> <!-- NorNE-nn -->
   <td class="no sent">32.66 ± 1.96 / 46.26 ± 3.19</td> <!-- NoReC -->
   <td class="no la">29.07 ± 2.20 / 63.35 ± 1.54</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">67.28 ± 1.09 / 72.13 ± 0.90</td> <!-- NorNE-nb -->
   <td class="no ner">67.28 ± 1.09 / 72.13 ± 0.90</td> <!-- NorNE-nn -->
   <td class="no sent">47.53 ± 0.94 / 62.73 ± 1.07</td> <!-- NoReC -->
   <td class="no la">14.63 ± 4.00 / 56.24 ± 2.51</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">65.59 ± 2.06 / 69.74 ± 1.81</td> <!-- NorNE-nb -->
   <td class="no ner">65.59 ± 2.06 / 69.74 ± 1.81</td> <!-- NorNE-nn -->
   <td class="no sent">29.68 ± 1.91 / 43.64 ± 2.18</td> <!-- NoReC -->
   <td class="no la">8.70 ± 4.78 / 52.69 ± 2.75</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">72.29 ± 1.44 / 76.65 ± 1.24</td> <!-- NorNE-nb -->
   <td class="no ner">72.29 ± 1.44 / 76.65 ± 1.24</td> <!-- NorNE-nn -->
   <td class="no sent">30.38 ± 2.29 / 42.84 ± 2.38</td> <!-- NoReC -->
   <td class="no la">19.06 ± 4.26 / 56.45 ± 5.24</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">55.90 ± 1.12 / 59.62 ± 1.19</td> <!-- NorNE-nb -->
   <td class="no ner">55.90 ± 1.12 / 59.62 ± 1.19</td> <!-- NorNE-nn -->
   <td class="no sent">25.98 ± 1.33 / 40.58 ± 0.60</td> <!-- NoReC -->
   <td class="no la">3.47 ± 1.47 / 48.98 ± 1.75</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.76 ± 0.90 / 79.80 ± 0.72</td> <!-- NorNE-nb -->
   <td class="no ner">75.76 ± 0.90 / 79.80 ± 0.72</td> <!-- NorNE-nn -->
   <td class="no sent">46.74 ± 5.96 / 60.25 ± 6.04</td> <!-- NoReC -->
   <td class="no la">17.04 ± 13.78 / 56.87 ± 7.06</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">68.61 ± 1.62 / 72.88 ± 1.50</td> <!-- NorNE-nb -->
   <td class="no ner">68.61 ± 1.62 / 72.88 ± 1.50</td> <!-- NorNE-nn -->
   <td class="no sent">32.29 ± 9.23 / 49.08 ± 8.36</td> <!-- NoReC -->
   <td class="no la">-0.08 ± 1.79 / 45.89 ± 3.49</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">59.95 ± 2.51 / 63.90 ± 2.54</td> <!-- NorNE-nb -->
   <td class="no ner">59.95 ± 2.51 / 63.90 ± 2.54</td> <!-- NorNE-nn -->
   <td class="no sent">18.85 ± 4.01 / 36.76 ± 2.79</td> <!-- NoReC -->
   <td class="no la">4.02 ± 2.29 / 51.66 ± 1.21</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da qa">1.58 ± 0.51 / 6.64 ± 1.56</td> <!-- ScandiQA-da -->
   <td class="no ner">24.10 ± 1.64 / 25.94 ± 1.70</td> <!-- NorNE-nb -->
   <td class="no ner">24.10 ± 1.64 / 25.94 ± 1.70</td> <!-- NorNE-nn -->
   <td class="no sent">12.60 ± 2.97 / 32.27 ± 3.43</td> <!-- NoReC -->
   <td class="no la">1.83 ± 1.64 / 37.67 ± 4.40</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da qa">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- ScandiQA-da -->
   <td class="no ner">11.65 ± 1.21 / 12.76 ± 1.29</td> <!-- NorNE-nb -->
   <td class="no ner">11.65 ± 1.21 / 12.76 ± 1.29</td> <!-- NorNE-nn -->
   <td class="no sent">15.29 ± 5.37 / 34.15 ± 4.23</td> <!-- NoReC -->
   <td class="no la">0.37 ± 0.69 / 35.08 ± 2.81</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">84.51 ± 1.03 / 87.74 ± 0.77</td> <!-- NorNE-nb -->
   <td class="no ner">84.51 ± 1.03 / 87.74 ± 0.77</td> <!-- NorNE-nn -->
   <td class="no sent">57.43 ± 1.55 / 70.43 ± 1.41</td> <!-- NoReC -->
   <td class="no la">62.79 ± 11.35 / 79.65 ± 6.48</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">83.48 ± 0.98 / 86.76 ± 0.82</td> <!-- NorNE-nb -->
   <td class="no ner">83.48 ± 0.98 / 86.76 ± 0.82</td> <!-- NorNE-nn -->
   <td class="no sent">52.19 ± 2.87 / 65.60 ± 2.58</td> <!-- NoReC -->
   <td class="no la">58.33 ± 10.94 / 77.88 ± 5.29</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">66.73 ± 1.21 / 70.94 ± 1.19</td> <!-- NorNE-nb -->
   <td class="no ner">66.73 ± 1.21 / 70.94 ± 1.19</td> <!-- NorNE-nn -->
   <td class="no sent">32.49 ± 1.55 / 43.12 ± 0.71</td> <!-- NoReC -->
   <td class="no la">21.11 ± 1.97 / 60.09 ± 0.93</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">72.08 ± 1.15 / 75.89 ± 1.11</td> <!-- NorNE-nb -->
   <td class="no ner">72.08 ± 1.15 / 75.89 ± 1.11</td> <!-- NorNE-nn -->
   <td class="no sent">33.42 ± 1.96 / 48.63 ± 3.34</td> <!-- NoReC -->
   <td class="no la">13.63 ± 4.52 / 53.34 ± 4.61</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">63.70 ± 2.54 / 67.70 ± 2.68</td> <!-- NorNE-nb -->
   <td class="no ner">63.70 ± 2.54 / 67.70 ± 2.68</td> <!-- NorNE-nn -->
   <td class="no sent">25.68 ± 2.17 / 41.65 ± 2.77</td> <!-- NoReC -->
   <td class="no la">3.35 ± 2.61 / 47.52 ± 3.20</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">81.88 ± 2.16 / 85.72 ± 1.92</td> <!-- NorNE-nb -->
   <td class="no ner">81.88 ± 2.16 / 85.72 ± 1.92</td> <!-- NorNE-nn -->
   <td class="no sent">50.90 ± 3.01 / 60.96 ± 5.41</td> <!-- NoReC -->
   <td class="no la">66.24 ± 2.41 / 82.36 ± 1.49</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">69.84 ± 1.91 / 74.05 ± 1.72</td> <!-- NorNE-nb -->
   <td class="no ner">69.84 ± 1.91 / 74.05 ± 1.72</td> <!-- NorNE-nn -->
   <td class="no sent">49.93 ± 1.46 / 62.37 ± 2.34</td> <!-- NoReC -->
   <td class="no la">25.17 ± 5.32 / 61.27 ± 3.01</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">68.32 ± 1.13 / 72.22 ± 0.95</td> <!-- NorNE-nb -->
   <td class="no ner">68.32 ± 1.13 / 72.22 ± 0.95</td> <!-- NorNE-nn -->
   <td class="no sent">44.59 ± 1.89 / 59.87 ± 1.84</td> <!-- NoReC -->
   <td class="no la">5.72 ± 3.29 / 50.40 ± 3.21</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da qa">28.67 ± 0.79 / 33.03 ± 0.87</td> <!-- ScandiQA-da -->
   <td class="no ner">75.74 ± 1.96 / 79.44 ± 1.66</td> <!-- NorNE-nb -->
   <td class="no ner">75.74 ± 1.96 / 79.44 ± 1.66</td> <!-- NorNE-nn -->
   <td class="no sent">38.17 ± 2.21 / 50.44 ± 3.11</td> <!-- NoReC -->
   <td class="no la">22.17 ± 7.22 / 60.16 ± 3.80</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">68.84 ± 1.39 / 73.03 ± 1.28</td> <!-- NorNE-nb -->
   <td class="no ner">68.84 ± 1.39 / 73.03 ± 1.28</td> <!-- NorNE-nn -->
   <td class="no sent">32.40 ± 1.48 / 44.59 ± 1.66</td> <!-- NoReC -->
   <td class="no la">25.53 ± 2.31 / 62.04 ± 1.19</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da sent">22.19 ± 2.04 / 41.57 ± 2.98</td> <!-- Angry Tweets -->
   <td class="da la">2.43 ± 1.83 / 49.01 ± 3.57</td> <!-- ScaLA-da -->
   <td class="da qa">1.98 ± 0.33 / 7.78 ± 0.68</td> <!-- ScandiQA-da -->
   <td class="no ner">32.27 ± 2.23 / 34.11 ± 2.36</td> <!-- NorNE-nb -->
   <td class="no ner">32.27 ± 2.23 / 34.11 ± 2.36</td> <!-- NorNE-nn -->
   <td class="no sent">20.93 ± 2.47 / 39.13 ± 1.34</td> <!-- NoReC -->
   <td class="no la">2.57 ± 1.59 / 49.43 ± 1.58</td> <!-- ScaLA-nb -->
   <td class="no la">2.57 ± 1.59 / 49.43 ± 1.58</td> <!-- ScaLA-nn -->
   <td class="no qa">1.80 ± 0.15 / 8.29 ± 0.41</td> <!-- ScandiQA-no -->
   ...
   <td class="sv qa">2.01 ± 0.23 / 8.77 ± 0.39</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
  ...
  <tr>
   ...
   <td class="no ner">43.01 ± 2.05 / 46.11 ± 2.15</td> <!-- NorNE-nb -->
   <td class="no ner">43.01 ± 2.05 / 46.11 ± 2.15</td> <!-- NorNE-nn -->
   <td class="no sent">23.21 ± 2.32 / 44.26 ± 2.95</td> <!-- NoReC -->
   <td class="no la">-0.66 ± 1.81 / 44.50 ± 3.45</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">50.23 ± 3.00 / 53.53 ± 3.03</td> <!-- NorNE-nb -->
   <td class="no ner">50.23 ± 3.00 / 53.53 ± 3.03</td> <!-- NorNE-nn -->
   <td class="no sent">12.69 ± 4.51 / 32.23 ± 3.53</td> <!-- NoReC -->
   <td class="no la">1.66 ± 2.18 / 46.60 ± 2.87</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">62.75 ± 1.40 / 66.78 ± 1.28</td> <!-- NorNE-nb -->
   <td class="no ner">62.75 ± 1.40 / 66.78 ± 1.28</td> <!-- NorNE-nn -->
   <td class="no sent">26.33 ± 1.84 / 40.67 ± 0.71</td> <!-- NoReC -->
   <td class="no la">5.16 ± 3.07 / 45.99 ± 4.76</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">33.22 ± 4.64 / 35.18 ± 4.90</td> <!-- NorNE-nb -->
   <td class="no ner">33.22 ± 4.64 / 35.18 ± 4.90</td> <!-- NorNE-nn -->
   <td class="no sent">19.19 ± 2.87 / 37.36 ± 1.97</td> <!-- NoReC -->
   <td class="no la">0.42 ± 1.04 / 49.39 ± 0.80</td> <!-- ScaLA-nb -->
   <td class="no la">0.42 ± 1.04 / 49.39 ± 0.80</td> <!-- ScaLA-nn -->
   <td class="no qa">3.46 ± 1.31 / 6.86 ± 2.76</td> <!-- ScandiQA-no -->
  ...
  <tr>
   ...
   <td class="no ner">79.22 ± 0.93 / 82.69 ± 0.90</td> <!-- NorNE-nb -->
   <td class="no ner">79.22 ± 0.93 / 82.69 ± 0.90</td> <!-- NorNE-nn -->
   <td class="no sent">34.97 ± 1.74 / 48.21 ± 2.02</td> <!-- NoReC -->
   <td class="no la">31.27 ± 9.57 / 62.81 ± 7.17</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">34.88 ± 1.76 / 37.39 ± 1.81</td> <!-- NorNE-nb -->
   <td class="no ner">34.88 ± 1.76 / 37.39 ± 1.81</td> <!-- NorNE-nn -->
   <td class="no sent">24.39 ± 1.60 / 40.44 ± 1.78</td> <!-- NoReC -->
   <td class="no la">2.57 ± 1.78 / 46.00 ± 3.32</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">80.56 ± 1.59 / 84.75 ± 1.23</td> <!-- NorNE-nb -->
   <td class="no ner">80.56 ± 1.59 / 84.75 ± 1.23</td> <!-- NorNE-nn -->
   <td class="no sent">55.25 ± 2.36 / 66.95 ± 2.79</td> <!-- NoReC -->
   <td class="no la">66.90 ± 2.07 / 82.33 ± 1.34</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">78.80 ± 2.22 / 83.27 ± 1.68</td> <!-- NorNE-nb -->
   <td class="no ner">78.80 ± 2.22 / 83.27 ± 1.68</td> <!-- NorNE-nn -->
   <td class="no sent">53.23 ± 1.67 / 65.23 ± 2.65</td> <!-- NoReC -->
   <td class="no la">66.81 ± 1.83 / 82.19 ± 1.20</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">71.27 ± 1.18 / 75.56 ± 1.01</td> <!-- NorNE-nb -->
   <td class="no ner">71.27 ± 1.18 / 75.56 ± 1.01</td> <!-- NorNE-nn -->
   <td class="no sent">55.53 ± 1.05 / 68.89 ± 1.16</td> <!-- NoReC -->
   <td class="no la">14.99 ± 8.03 / 54.08 ± 5.71</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.64 ± 1.17 / 79.71 ± 1.02</td> <!-- NorNE-nb -->
   <td class="no ner">75.64 ± 1.17 / 79.71 ± 1.02</td> <!-- NorNE-nn -->
   <td class="no sent">52.91 ± 2.29 / 64.64 ± 3.28</td> <!-- NoReC -->
   <td class="no la">15.20 ± 9.06 / 51.91 ± 4.95</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">62.07 ± 1.31 / 66.34 ± 1.25</td> <!-- NorNE-nb -->
   <td class="no ner">62.07 ± 1.31 / 66.34 ± 1.25</td> <!-- NorNE-nn -->
   <td class="no sent">29.97 ± 0.99 / 42.12 ± 0.47</td> <!-- NoReC -->
   <td class="no la">25.08 ± 1.86 / 61.74 ± 0.81</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">81.89 ± 0.98 / 86.04 ± 0.78</td> <!-- NorNE-nb -->
   <td class="no ner">81.89 ± 0.98 / 86.04 ± 0.78</td> <!-- NorNE-nn -->
   <td class="no sent">56.35 ± 1.25 / 69.31 ± 1.02</td> <!-- NoReC -->
   <td class="no la">46.54 ± 3.21 / 71.78 ± 2.00</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.17 ± 2.67 / 80.10 ± 2.44</td> <!-- NorNE-nb -->
   <td class="no ner">76.17 ± 2.67 / 80.10 ± 2.44</td> <!-- NorNE-nn -->
   <td class="no sent">34.17 ± 2.42 / 43.74 ± 2.19</td> <!-- NoReC -->
   <td class="no la">4.28 ± 4.18 / 45.75 ± 4.32</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">82.16 ± 1.96 / 86.11 ± 1.67</td> <!-- NorNE-nb -->
   <td class="no ner">82.16 ± 1.96 / 86.11 ± 1.67</td> <!-- NorNE-nn -->
   <td class="no sent">54.19 ± 3.15 / 65.18 ± 4.55</td> <!-- NoReC -->
   <td class="no la">54.84 ± 12.59 / 75.13 ± 9.44</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">72.83 ± 1.96 / 77.33 ± 2.00</td> <!-- NorNE-nb -->
   <td class="no ner">72.83 ± 1.96 / 77.33 ± 2.00</td> <!-- NorNE-nn -->
   <td class="no sent">37.28 ± 2.13 / 48.69 ± 3.26</td> <!-- NoReC -->
   <td class="no la">43.58 ± 2.23 / 71.20 ± 1.61</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.07 ± 1.03 / 79.39 ± 1.03</td> <!-- NorNE-nb -->
   <td class="no ner">75.07 ± 1.03 / 79.39 ± 1.03</td> <!-- NorNE-nn -->
   <td class="no sent">32.32 ± 2.30 / 47.12 ± 2.85</td> <!-- NoReC -->
   <td class="no la">30.17 ± 1.72 / 63.98 ± 1.36</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">56.03 ± 1.41 / 59.90 ± 1.56</td> <!-- NorNE-nb -->
   <td class="no ner">56.03 ± 1.41 / 59.90 ± 1.56</td> <!-- NorNE-nn -->
   <td class="no sent">24.59 ± 1.57 / 40.34 ± 0.99</td> <!-- NoReC -->
   <td class="no la">2.72 ± 1.56 / 48.79 ± 1.92</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">30.59 ± 1.43 / 32.47 ± 1.48</td> <!-- NorNE-nb -->
   <td class="no ner">30.59 ± 1.43 / 32.47 ± 1.48</td> <!-- NorNE-nn -->
   <td class="no sent">15.07 ± 1.97 / 35.80 ± 1.15</td> <!-- NoReC -->
   <td class="no la">0.49 ± 1.58 / 45.93 ± 3.88</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">72.90 ± 1.43 / 76.64 ± 1.10</td> <!-- NorNE-nb -->
   <td class="no ner">72.90 ± 1.43 / 76.64 ± 1.10</td> <!-- NorNE-nn -->
   <td class="no sent">40.20 ± 1.56 / 54.68 ± 2.46</td> <!-- NoReC -->
   <td class="no la">19.18 ± 3.55 / 57.93 ± 2.05</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">84.23 ± 0.85 / 87.58 ± 0.68</td> <!-- NorNE-nb -->
   <td class="no ner">84.23 ± 0.85 / 87.58 ± 0.68</td> <!-- NorNE-nn -->
   <td class="no sent">59.98 ± 1.33 / 71.70 ± 1.69</td> <!-- NoReC -->
   <td class="no la">70.81 ± 1.50 / 84.45 ± 0.95</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">83.35 ± 2.01 / 86.85 ± 1.94</td> <!-- NorNE-nb -->
   <td class="no ner">83.35 ± 2.01 / 86.85 ± 1.94</td> <!-- NorNE-nn -->
   <td class="no sent">59.84 ± 1.40 / 72.11 ± 1.25</td> <!-- NoReC -->
   <td class="no la">71.06 ± 1.62 / 84.78 ± 1.05</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">74.97 ± 3.56 / 78.60 ± 3.17</td> <!-- NorNE-nb -->
   <td class="no ner">74.97 ± 3.56 / 78.60 ± 3.17</td> <!-- NorNE-nn -->
   <td class="no sent">17.93 ± 14.48 / 34.24 ± 10.14</td> <!-- NoReC -->
   <td class="no la">10.97 ± 10.84 / 43.47 ± 9.81</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">81.19 ± 1.37 / 84.11 ± 1.13</td> <!-- NorNE-nn -->
   <td class="no sent">39.63 ± 1.06 / 49.23 ± 2.13</td> <!-- NoReC -->
   <td class="no la">33.74 ± 2.91 / 63.89 ± 3.31</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">76.65 ± 1.46 / 79.91 ± 1.17</td> <!-- NorNE-nb -->
   <td class="no ner">76.65 ± 1.46 / 79.91 ± 1.17</td> <!-- NorNE-nn -->
   <td class="no sent">47.84 ± 2.44 / 60.67 ± 3.47</td> <!-- NoReC -->
   <td class="no la">30.57 ± 8.63 / 62.90 ± 7.32</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">51.50 ± 1.21 / 55.29 ± 1.26</td> <!-- NorNE-nb -->
   <td class="no ner">51.50 ± 1.21 / 55.29 ± 1.26</td> <!-- NorNE-nn -->
   <td class="no sent">33.31 ± 2.87 / 48.75 ± 3.38</td> <!-- NoReC -->
   <td class="no la">8.07 ± 2.44 / 53.43 ± 1.32</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">57.87 ± 2.08 / 61.77 ± 2.03</td> <!-- NorNE-nb -->
   <td class="no ner">57.87 ± 2.08 / 61.77 ± 2.03</td> <!-- NorNE-nn -->
   <td class="no sent">36.56 ± 1.53 / 51.54 ± 2.45</td> <!-- NoReC -->
   <td class="no la">5.40 ± 4.63 / 44.64 ± 6.37</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">80.07 ± 2.11 / 84.59 ± 1.98</td> <!-- NorNE-nb -->
   <td class="no ner">80.07 ± 2.11 / 84.59 ± 1.98</td> <!-- NorNE-nn -->
   <td class="no sent">55.59 ± 10.43 / 67.82 ± 9.45</td> <!-- NoReC -->
   <td class="no la">53.30 ± 13.11 / 74.52 ± 7.96</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">81.01 ± 1.95 / 84.88 ± 1.55</td> <!-- NorNE-nb -->
   <td class="no ner">81.01 ± 1.95 / 84.88 ± 1.55</td> <!-- NorNE-nn -->
   <td class="no sent">52.44 ± 2.90 / 62.48 ± 4.62</td> <!-- NoReC -->
   <td class="no la">65.40 ± 2.43 / 81.72 ± 1.68</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da sent">50.98 ± 1.25 / 67.18 ± 0.86</td> <!-- Angry Tweets -->
   <td class="da la">57.33 ± 11.34 / 77.46 ± 5.70</td> <!-- ScaLA-da -->
   <td class="da qa">43.15 ± 0.97 / 49.22 ± 0.89</td> <!-- ScandiQA-da -->
   <td class="no ner">83.50 ± 0.95 / 86.79 ± 0.87</td> <!-- NorNE-nb -->
   <td class="no ner">83.50 ± 0.95 / 86.79 ± 0.87</td> <!-- NorNE-nn -->
   <td class="no sent">52.87 ± 2.07 / 65.06 ± 2.55</td> <!-- NoReC -->
   <td class="no la">58.36 ± 1.37 / 78.55 ± 0.87</td> <!-- ScaLA-nb -->
   <td class="no la">58.36 ± 1.37 / 78.55 ± 0.87</td> <!-- ScaLA-nn -->
   <td class="no qa">43.13 ± 0.98 / 49.16 ± 0.88</td> <!-- ScandiQA-no -->
   ...
   <td class="sv qa">44.79 ± 0.80 / 50.85 ± 0.68</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="no ner">56.64 ± 1.98 / 60.00 ± 1.99</td> <!-- NorNE-nb -->
   <td class="no ner">56.64 ± 1.98 / 60.00 ± 1.99</td> <!-- NorNE-nn -->
   <td class="no sent">38.94 ± 2.59 / 53.58 ± 3.33</td> <!-- NoReC -->
   <td class="no la">7.99 ± 3.34 / 53.24 ± 1.64</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">75.70 ± 2.31 / 80.19 ± 2.00</td> <!-- NorNE-nb -->
   <td class="no ner">75.70 ± 2.31 / 80.19 ± 2.00</td> <!-- NorNE-nn -->
   <td class="no sent">49.92 ± 1.44 / 63.75 ± 1.45</td> <!-- NoReC -->
   <td class="no la">5.06 ± 0.83 / 51.44 ± 1.05</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">83.03 ± 1.53 / 86.52 ± 1.17</td> <!-- NorNE-nb -->
   <td class="no ner">83.03 ± 1.53 / 86.52 ± 1.17</td> <!-- NorNE-nn -->
   <td class="no sent">51.36 ± 3.24 / 61.35 ± 5.46</td> <!-- NoReC -->
   <td class="no la">56.67 ± 2.29 / 76.74 ± 1.73</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">85.45 ± 1.21 / 88.49 ± 0.97</td> <!-- NorNE-nb -->
   <td class="no ner">85.45 ± 1.21 / 88.49 ± 0.97</td> <!-- NorNE-nn -->
   <td class="no sent">59.73 ± 2.46 / 70.77 ± 3.26</td> <!-- NoReC -->
   <td class="no la">68.85 ± 3.21 / 83.17 ± 2.09</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">86.03 ± 0.65 / 89.39 ± 0.52</td> <!-- NorNE-nb -->
   <td class="no ner">86.03 ± 0.65 / 89.39 ± 0.52</td> <!-- NorNE-nn -->
   <td class="no sent">64.62 ± 1.36 / 75.40 ± 0.97</td> <!-- NoReC -->
   <td class="no la">76.30 ± 1.56 / 87.68 ± 0.86</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="da sent">42.97 ± 1.86 / 61.51 ± 1.50</td> <!-- Angry Tweets -->
   <td class="da la">57.15 ± 1.84 / 77.44 ± 1.26</td> <!-- ScaLA-da -->
   <td class="da qa">0.90 ± 0.30 / 4.19 ± 1.12</td> <!-- ScandiQA-da -->
   <td class="no ner">83.63 ± 1.07 / 87.06 ± 0.79</td> <!-- NorNE-nb -->
   <td class="no ner">83.63 ± 1.07 / 87.06 ± 0.79</td> <!-- NorNE-nn -->
   <td class="no sent">57.37 ± 1.73 / 68.85 ± 1.96</td> <!-- NoReC -->
   <td class="no la">67.31 ± 1.65 / 82.81 ± 1.09</td> <!-- ScaLA-nb -->
   <td class="no la">67.31 ± 1.65 / 82.81 ± 1.09</td> <!-- ScaLA-nn -->
   <td class="no qa">1.59 ± 0.49 / 6.12 ± 1.42</td> <!-- ScandiQA-no -->
   ...
   <td class="sv qa">1.31 ± 0.51 / 5.22 ± 1.36</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="da sent">42.73 ± 1.14 / 61.44 ± 0.88</td> <!-- Angry Tweets -->
   <td class="da la">53.31 ± 2.13 / 75.84 ± 1.15</td> <!-- ScaLA-da -->
   <td class="da qa">0.90 ± 0.30 / 4.19 ± 1.12</td> <!-- ScandiQA-da -->
   <td class="no ner">83.48 ± 1.21 / 86.89 ± 1.04</td> <!-- NorNE-nb -->
   <td class="no ner">83.48 ± 1.21 / 86.89 ± 1.04</td> <!-- NorNE-nn -->
   <td class="no sent">55.28 ± 3.22 / 63.87 ± 5.64</td> <!-- NoReC -->
   <td class="no la">67.67 ± 2.15 / 83.37 ± 1.21</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="speed">14,277 ± 3,716 / 4,754 ± 1,532</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="da sent">8.73 ± 5.50 / 26.96 ± 4.13</td> <!-- Angry Tweets -->
   <td class="da la">0.98 ± 1.29 / 36.58 ± 2.04</td> <!-- ScaLA-da -->
   ...
   <td class="no sent">1.65 ± 1.10 / 10.67 ± 0.61</td> <!-- NoReC -->
   <td class="no la">-1.07 ± 1.43 / 47.14 ± 1.26</td> <!-- ScaLA-nb -->
   <td class="no la">-1.07 ± 1.43 / 47.14 ± 1.26</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 2.83 ± 0.54</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.04 ± 0.07 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">7.93 ± 5.42 / 21.22 ± 3.34</td> <!-- SweReC -->
   <td class="sv la">-1.68 ± 1.40 / 43.86 ± 3.06</td> <!-- ScaLA-sv -->
  ...
  <tr>
   ...
   <td class="no ner">68.02 ± 1.41 / 75.34 ± 1.15</td> <!-- NorNE-nb -->
   <td class="no ner">68.02 ± 1.41 / 75.34 ± 1.15</td> <!-- NorNE-nn -->
   <td class="no sent">57.64 ± 1.33 / 71.34 ± 1.15</td> <!-- NoReC -->
   <td class="no la">34.22 ± 2.98 / 57.61 ± 3.23</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="vocabulary_size">64</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">2048</td> <!-- Maximum sequence length of the model-->
   <td class="speed">6,448 ± 1,641 / 2,245 ± 721</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">29.00 ± 4.05 / 43.27 ± 2.74</td> <!-- Angry Tweets -->
   <td class="da la">1.64 ± 1.26 / 35.41 ± 0.99</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 5.57 ± 1.24</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">29.15 ± 3.75 / 47.20 ± 2.50</td> <!-- NoReC -->
   <td class="no la">0.30 ± 1.68 / 37.90 ± 1.43</td> <!-- ScaLA-nb -->
   <td class="no la">0.30 ± 1.68 / 37.90 ± 1.43</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 4.61 ± 0.42</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">47.32 ± 10.53 / 45.14 ± 6.56</td> <!-- SweReC -->
   <td class="sv la">0.29 ± 1.20 / 36.05 ± 0.99</td> <!-- ScaLA-sv -->
  ...
  <tr>
   ...
   <td class="vocabulary_size">64</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">2048</td> <!-- Maximum sequence length of the model-->
   <td class="speed">3,403 ± 670 / 1,502 ± 448</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">33.37 ± 2.55 / 54.38 ± 2.19</td> <!-- Angry Tweets -->
   <td class="da la">1.30 ± 1.73 / 48.33 ± 1.82</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 11.00 ± 0.79</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">26.24 ± 3.40 / 49.76 ± 2.30</td> <!-- NoReC -->
   <td class="no la">1.78 ± 1.54 / 38.67 ± 3.31</td> <!-- ScaLA-nb -->
   <td class="no la">1.78 ± 1.54 / 38.67 ± 3.31</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 11.40 ± 1.23</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">68.16 ± 1.98 / 70.93 ± 1.36</td> <!-- SweReC -->
  ...
  <tr>
   ...
   <td class="no ner">60.44 ± 5.46 / 75.75 ± 4.49</td> <!-- NorNE-nb -->
   <td class="no ner">60.44 ± 5.46 / 75.75 ± 4.49</td> <!-- NorNE-nn -->
   <td class="no sent">72.72 ± 3.20 / 81.35 ± 2.22</td> <!-- NoReC -->
   <td class="no la">57.18 ± 3.91 / 76.40 ± 2.66</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">67.96 ± 2.67 / 73.92 ± 2.53</td> <!-- NorNE-nb -->
   <td class="no ner">67.96 ± 2.67 / 73.92 ± 2.53</td> <!-- NorNE-nn -->
   <td class="no sent">58.88 ± 3.23 / 71.00 ± 2.87</td> <!-- NoReC -->
   <td class="no la">32.82 ± 3.43 / 56.05 ± 4.14</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">86.52 ± 0.94 / 84.32 ± 1.08</td> <!-- NorNE-nb -->
   <td class="no ner">86.52 ± 0.94 / 84.32 ± 1.08</td> <!-- NorNE-nn -->
   <td class="no sent">61.52 ± 1.87 / 72.72 ± 1.95</td> <!-- NoReC -->
   <td class="no la">34.88 ± 11.23 / 66.51 ± 5.72</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">82.71 ± 1.13 / 80.57 ± 1.41</td> <!-- NorNE-nb -->
   <td class="no ner">82.71 ± 1.13 / 80.57 ± 1.41</td> <!-- NorNE-nn -->
   <td class="no sent">47.11 ± 2.05 / 60.70 ± 3.19</td> <!-- NoReC -->
   <td class="no la">25.06 ± 6.94 / 60.75 ± 4.12</td> <!-- ScaLA-nb -->
   <td class="no la">25.06 ± 6.94 / 60.75 ± 4.12</td> <!-- ScaLA-nn -->
   <td class="no qa">33.89 ± 1.48 / 38.31 ± 1.78</td> <!-- ScandiQA-no -->
  ...
  <tr>
   ...
   <td class="no ner">88.83 ± 0.84 / 87.30 ± 1.07</td> <!-- NorNE-nb -->
   <td class="no ner">88.83 ± 0.84 / 87.30 ± 1.07</td> <!-- NorNE-nn -->
   <td class="no sent">59.10 ± 1.47 / 70.50 ± 2.06</td> <!-- NoReC -->
   <td class="no la">72.94 ± 1.63 / 86.07 ± 0.99</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">82.22 ± 1.30 / 83.28 ± 1.29</td> <!-- NorNE-nb -->
   <td class="no ner">82.22 ± 1.30 / 83.28 ± 1.29</td> <!-- NorNE-nn -->
   <td class="no sent">58.73 ± 2.31 / 70.10 ± 2.66</td> <!-- NoReC -->
   <td class="no la">59.58 ± 7.22 / 78.86 ± 3.51</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="no ner">83.89 ± 1.34 / 81.37 ± 1.67</td> <!-- NorNE-nb -->
   <td class="no ner">83.89 ± 1.34 / 81.37 ± 1.67</td> <!-- NorNE-nn -->
   <td class="no sent">54.61 ± 1.51 / 67.19 ± 1.65</td> <!-- NoReC -->
   <td class="no la">22.15 ± 9.02 / 58.20 ± 5.38</td> <!-- ScaLA-nb -->
   <td class="no la">22.15 ± 9.02 / 58.20 ± 5.38</td> <!-- ScaLA-nn -->
   <td class="no qa">38.18 ± 2.42 / 43.93 ± 2.33</td> <!-- ScandiQA-no -->
  ...
  <tr>
   ...
   <td class="no ner">82.50 ± 1.19 / 83.22 ± 1.44</td> <!-- NorNE-nb -->
   <td class="no ner">82.50 ± 1.19 / 83.22 ± 1.44</td> <!-- NorNE-nn -->
   <td class="no sent">59.61 ± 1.28 / 71.40 ± 1.68</td> <!-- NoReC -->
   <td class="no la">62.44 ± 4.39 / 80.43 ± 2.39</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">3.62 ± 3.14 / 26.55 ± 3.60</td> <!-- Angry Tweets -->
   ...
   <td class="no la">1.01 ± 1.45 / 33.76 ± 1.06</td> <!-- ScaLA-nb -->
  ...
  <tr>
   ...
   <td class="vocabulary_size">32</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">4096</td> <!-- Maximum sequence length of the model-->
   <td class="speed">775 ± 128 / 227 ± 66</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.08 ± 0.15 / 0.10 ± 0.19</td> <!-- DaNE -->
   <td class="da sent">40.75 ± 1.68 / 57.97 ± 1.85</td> <!-- Angry Tweets -->
   <td class="da la">4.95 ± 2.14 / 46.82 ± 3.71</td> <!-- ScaLA-da -->
   <td class="da qa">0.21 ± 0.15 / 14.76 ± 1.38</td> <!-- ScandiQA-da -->
   <td class="no ner">0.06 ± 0.10 / 0.07 ± 0.12</td> <!-- NorNE-nb -->
   <td class="no ner">0.06 ± 0.10 / 0.07 ± 0.12</td> <!-- NorNE-nn -->
   <td class="no sent">34.57 ± 2.18 / 50.94 ± 3.14</td> <!-- NoReC -->
   <td class="no la">1.42 ± 1.50 / 44.76 ± 4.38</td> <!-- ScaLA-nb -->
   <td class="no la">1.42 ± 1.50 / 44.76 ± 4.38</td> <!-- ScaLA-nn -->
   <td class="no qa">0.11 ± 0.10 / 13.23 ± 0.98</td> <!-- ScandiQA-no -->
   <td class="sv ner">2.00 ± 0.74 / 2.21 ± 0.82</td> <!-- SUC3 -->
   <td class="sv sent">68.67 ± 1.91 / 72.64 ± 1.41</td> <!-- SweReC -->
   <td class="sv la">0.77 ± 1.49 / 42.96 ± 3.52</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.39 ± 0.20 / 16.33 ± 1.01</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>meta-llama/Llama-2-13b-hf (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">328</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">32</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">4096</td> <!-- Maximum sequence length of the model-->
   <td class="speed">347 ± 51 / 123 ± 35</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">5.14 ± 1.97 / 6.16 ± 2.41</td> <!-- DaNE -->
   <td class="da sent">19.60 ± 4.90 / 33.32 ± 6.52</td> <!-- Angry Tweets -->
   <td class="da la">10.72 ± 1.80 / 52.01 ± 2.37</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 12.03 ± 1.84</td> <!-- ScandiQA-da -->
   <td class="no ner">22.48 ± 3.50 / 22.92 ± 3.98</td> <!-- NorNE-nb -->
   <td class="no ner">22.48 ± 3.50 / 22.92 ± 3.98</td> <!-- NorNE-nn -->
   <td class="no sent">23.48 ± 3.99 / 40.05 ± 4.52</td> <!-- NoReC -->
   <td class="no la">4.18 ± 1.85 / 47.57 ± 2.70</td> <!-- ScaLA-nb -->
   <td class="no la">4.18 ± 1.85 / 47.57 ± 2.70</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 15.94 ± 2.90</td> <!-- ScandiQA-no -->
   <td class="sv ner">14.82 ± 2.22 / 15.89 ± 2.56</td> <!-- SUC3 -->
   <td class="sv sent">67.74 ± 4.00 / 72.14 ± 2.86</td> <!-- SweReC -->
   <td class="sv la">6.44 ± 2.51 / 51.75 ± 1.64</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.01 ± 0.02 / 20.63 ± 1.82</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="vocabulary_size">32</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">4096</td> <!-- Maximum sequence length of the model-->
   <td class="speed">342 ± 49 / 122 ± 35</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">6.32 ± 2.34 / 7.33 ± 2.76</td> <!-- DaNE -->
   <td class="da sent">42.73 ± 2.25 / 60.16 ± 2.75</td> <!-- Angry Tweets -->
   <td class="da la">7.10 ± 2.73 / 52.27 ± 1.35</td> <!-- ScaLA-da -->
   <td class="da qa">0.26 ± 0.10 / 18.23 ± 0.74</td> <!-- ScandiQA-da -->
   <td class="no ner">11.89 ± 1.98 / 13.28 ± 2.56</td> <!-- NorNE-nb -->
   <td class="no ner">11.89 ± 1.98 / 13.28 ± 2.56</td> <!-- NorNE-nn -->
   <td class="no sent">40.27 ± 3.58 / 58.77 ± 3.53</td> <!-- NoReC -->
   <td class="no la">1.89 ± 1.77 / 45.56 ± 3.57</td> <!-- ScaLA-nb -->
   <td class="no la">1.89 ± 1.77 / 45.56 ± 3.57</td> <!-- ScaLA-nn -->
   <td class="no qa">0.57 ± 0.16 / 24.48 ± 0.61</td> <!-- ScandiQA-no -->
   <td class="sv ner">7.28 ± 3.47 / 8.51 ± 4.76</td> <!-- SUC3 -->
   <td class="sv sent">72.93 ± 2.64 / 75.74 ± 1.92</td> <!-- SweReC -->
   <td class="sv la">5.05 ± 1.72 / 48.91 ± 2.03</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.46 ± 0.14 / 24.84 ± 0.37</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-tiny (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">52</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">50</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">23,539 ± 6,668 / 3,723 ± 1,246</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">1.13 ± 1.14 / 14.27 ± 0.35</td> <!-- Angry Tweets -->
   <td class="da la">-0.74 ± 1.11 / 34.12 ± 0.64</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.19 ± 0.02</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">-1.32 ± 0.89 / 17.27 ± 0.20</td> <!-- NoReC -->
   <td class="no la">0.76 ± 1.52 / 33.47 ± 0.58</td> <!-- ScaLA-nb -->
   <td class="no la">0.76 ± 1.52 / 33.47 ± 0.58</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.18 ± 0.02</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-2.58 ± 1.67 / 22.36 ± 0.43</td> <!-- SweReC -->
   <td class="sv la">1.19 ± 1.15 / 34.44 ± 0.44</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.21 ± 0.02</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>KennethTM/gpt2-small-danish (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">39</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">50</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">15,750 ± 3,744 / 2,972 ± 954</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">3.38 ± 2.04 / 24.41 ± 3.27</td> <!-- Angry Tweets -->
   <td class="da la">0.40 ± 1.72 / 38.78 ± 3.78</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.80 ± 0.21</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">0.46 ± 2.17 / 18.50 ± 1.55</td> <!-- NoReC -->
   <td class="no la">-0.49 ± 1.62 / 40.92 ± 3.90</td> <!-- ScaLA-nb -->
   <td class="no la">-0.49 ± 1.62 / 40.92 ± 3.90</td> <!-- ScaLA-nn -->
   <td class="no qa">0.01 ± 0.02 / 0.66 ± 0.14</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">8.58 ± 6.58 / 26.19 ± 3.84</td> <!-- SweReC -->
   <td class="sv la">0.00 ± 0.00 / 33.37 ± 0.27</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.01 ± 0.02 / 0.74 ± 0.22</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">357</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">974 ± 376 / 140 ± 49</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">6.54 ± 2.56 / 23.42 ± 2.90</td> <!-- Angry Tweets -->
   <td class="da la">-0.52 ± 1.72 / 36.20 ± 3.01</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.31 ± 0.03</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">3.41 ± 1.99 / 22.39 ± 2.37</td> <!-- NoReC -->
   <td class="no la">-0.37 ± 1.53 / 38.29 ± 4.04</td> <!-- ScaLA-nb -->
   <td class="no la">-0.37 ± 1.53 / 38.29 ± 4.04</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.19 ± 0.03</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-4.13 ± 1.26 / 19.27 ± 0.22</td> <!-- SweReC -->
   <td class="sv la">1.21 ± 2.00 / 39.93 ± 3.93</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.21 ± 0.03</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small-fcm (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">206</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,053 ± 339 / 136 ± 55</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">2.48 ± 1.64 / 21.73 ± 2.72</td> <!-- Angry Tweets -->
   <td class="da la">-0.12 ± 1.29 / 38.80 ± 2.90</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.46 ± 0.06</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">1.48 ± 0.84 / 17.06 ± 2.16</td> <!-- NoReC -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nb -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.44 ± 0.10</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-2.30 ± 6.35 / 21.17 ± 2.31</td> <!-- SweReC -->
   <td class="sv la">0.00 ± 0.00 / 33.37 ± 0.27</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.29 ± 0.06</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small-fim (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">206</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,090 ± 380 / 133 ± 45</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">-0.59 ± 1.74 / 20.51 ± 1.92</td> <!-- Angry Tweets -->
   <td class="da la">-0.87 ± 1.53 / 42.81 ± 4.04</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.26 ± 0.06</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">0.33 ± 1.24 / 11.09 ± 1.26</td> <!-- NoReC -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nb -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.20 ± 0.05</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-1.61 ± 3.81 / 20.39 ± 0.86</td> <!-- SweReC -->
   <td class="sv la">0.61 ± 1.72 / 40.89 ± 3.75</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.15 ± 0.02</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small-hfcm (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">206</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,007 ± 323 / 135 ± 45</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">7.44 ± 3.12 / 26.56 ± 3.78</td> <!-- Angry Tweets -->
   <td class="da la">-0.01 ± 1.00 / 36.99 ± 2.85</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.47 ± 0.07</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">3.54 ± 2.02 / 15.68 ± 4.49</td> <!-- NoReC -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nb -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.35 ± 0.07</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-4.56 ± 3.11 / 19.39 ± 1.04</td> <!-- SweReC -->
   <td class="sv la">0.00 ± 0.00 / 33.37 ± 0.27</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.24 ± 0.03</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small-fim-512 (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">206</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">512</td> <!-- Maximum sequence length of the model-->
   <td class="speed">911 ± 249 / 137 ± 56</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">4.24 ± 2.51 / 22.26 ± 3.07</td> <!-- Angry Tweets -->
   <td class="da la">0.00 ± 0.00 / 33.41 ± 0.23</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.58 ± 0.06</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">0.14 ± 1.36 / 10.28 ± 1.26</td> <!-- NoReC -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nb -->
   <td class="no la">0.00 ± 0.00 / 33.86 ± 0.33</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.36 ± 0.06</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-4.19 ± 2.28 / 19.77 ± 0.95</td> <!-- SweReC -->
   <td class="sv la">0.22 ± 0.44 / 33.38 ± 0.27</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.26 ± 0.02</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>peter-sk/gpt-neox-da-small-tfcm (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">206</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">100</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,000 ± 329 / 129 ± 48</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">5.59 ± 1.83 / 28.76 ± 2.83</td> <!-- Angry Tweets -->
   <td class="da la">-1.78 ± 0.97 / 38.45 ± 3.57</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.52 ± 0.05</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">6.07 ± 1.58 / 22.63 ± 2.60</td> <!-- NoReC -->
   <td class="no la">-0.21 ± 0.41 / 33.86 ± 0.33</td> <!-- ScaLA-nb -->
   <td class="no la">-0.21 ± 0.41 / 33.86 ± 0.33</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.40 ± 0.07</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">-0.89 ± 4.98 / 28.63 ± 3.41</td> <!-- SweReC -->
   <td class="sv la">-0.35 ± 1.55 / 34.71 ± 1.76</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.26 ± 0.04</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="vocabulary_size">50</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">1024</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,184 ± 248 / 453 ± 147</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">7.32 ± 1.82 / 23.12 ± 1.95</td> <!-- Angry Tweets -->
   <td class="da la">-0.78 ± 1.35 / 36.54 ± 2.93</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 0.41 ± 0.03</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">2.49 ± 1.81 / 20.86 ± 3.70</td> <!-- NoReC -->
   <td class="no la">1.03 ± 1.75 / 39.55 ± 3.19</td> <!-- ScaLA-nb -->
   <td class="no la">1.03 ± 1.75 / 39.55 ± 3.19</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 0.31 ± 0.03</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">1.97 ± 2.43 / 23.30 ± 5.48</td> <!-- SweReC -->
   <td class="sv la">-0.70 ± 0.86 / 34.57 ± 1.85</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 0.27 ± 0.03</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>AI-Sweden-Models/gpt-sw3-20b (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">407</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">64</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">2048</td> <!-- Maximum sequence length of the model-->
   <td class="speed">233 ± 30 / 93 ± 27</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.02 ± 0.03 / 0.02 ± 0.05</td> <!-- DaNE -->
   <td class="da sent">34.22 ± 3.83 / 44.86 ± 5.13</td> <!-- Angry Tweets -->
   <td class="da la">9.64 ± 3.42 / 45.09 ± 4.28</td> <!-- ScaLA-da -->
   <td class="da qa">0.02 ± 0.02 / 18.07 ± 1.97</td> <!-- ScandiQA-da -->
   <td class="no ner">0.06 ± 0.06 / 0.08 ± 0.08</td> <!-- NorNE-nb -->
   <td class="no ner">0.06 ± 0.06 / 0.08 ± 0.08</td> <!-- NorNE-nn -->
   <td class="no sent">34.98 ± 1.99 / 45.78 ± 2.97</td> <!-- NoReC -->
   <td class="no la">11.87 ± 2.35 / 50.48 ± 3.88</td> <!-- ScaLA-nb -->
   <td class="no la">11.87 ± 2.35 / 50.48 ± 3.88</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 19.49 ± 0.60</td> <!-- ScandiQA-no -->
   <td class="sv ner">8.66 ± 3.21 / 9.74 ± 3.87</td> <!-- SUC3 -->
   <td class="sv sent">77.95 ± 1.79 / 79.26 ± 1.55</td> <!-- SweReC -->
   <td class="sv la">8.09 ± 2.65 / 40.83 ± 3.89</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.09 ± 0.08 / 18.53 ± 2.18</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="vocabulary_size">64</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">2048</td> <!-- Maximum sequence length of the model-->
   <td class="speed">235 ± 31 / 93 ± 27</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">2.83 ± 1.92 / 3.35 ± 2.21</td> <!-- DaNE -->
   <td class="da sent">39.37 ± 2.41 / 57.10 ± 2.87</td> <!-- Angry Tweets -->
   <td class="da la">5.21 ± 1.94 / 48.84 ± 1.28</td> <!-- ScaLA-da -->
   <td class="da qa">0.19 ± 0.09 / 12.21 ± 0.87</td> <!-- ScandiQA-da -->
   <td class="no ner">0.13 ± 0.13 / 0.13 ± 0.14</td> <!-- NorNE-nb -->
   <td class="no ner">0.13 ± 0.13 / 0.13 ± 0.14</td> <!-- NorNE-nn -->
   <td class="no sent">42.18 ± 4.17 / 60.62 ± 3.70</td> <!-- NoReC -->
   <td class="no la">4.66 ± 2.54 / 45.98 ± 2.48</td> <!-- ScaLA-nb -->
   <td class="no la">4.66 ± 2.54 / 45.98 ± 2.48</td> <!-- ScaLA-nn -->
   <td class="no qa">0.22 ± 0.11 / 12.80 ± 0.78</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">71.72 ± 3.04 / 73.91 ± 2.15</td> <!-- SweReC -->
   <td class="sv la">9.21 ± 1.31 / 53.99 ± 0.79</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.20 ± 0.12 / 17.42 ± 0.82</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   <td>AI-Sweden-Models/gpt-sw3-40b (few-shot)</td> <!-- Model ID -->
   <td class="num_model_parameters">543</td> <!-- Number of trainable parameters -->
   <td class="vocabulary_size">64</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">2048</td> <!-- Maximum sequence length of the model-->
   <td class="speed">124 ± 15 / 52 ± 14</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">18.65 ± 3.43 / 23.78 ± 6.18</td> <!-- DaNE -->
   <td class="da sent">44.56 ± 2.61 / 58.97 ± 3.70</td> <!-- Angry Tweets -->
   <td class="da la">10.28 ± 1.89 / 50.57 ± 2.53</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 16.17 ± 2.63</td> <!-- ScandiQA-da -->
   <td class="no ner">22.04 ± 2.12 / 25.48 ± 4.46</td> <!-- NorNE-nb -->
   <td class="no ner">22.04 ± 2.12 / 25.48 ± 4.46</td> <!-- NorNE-nn -->
   <td class="no sent">21.26 ± 6.16 / 34.71 ± 6.40</td> <!-- NoReC -->
   <td class="no la">6.44 ± 2.00 / 44.23 ± 4.66</td> <!-- ScaLA-nb -->
   <td class="no la">6.44 ± 2.00 / 44.23 ± 4.66</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 18.24 ± 2.00</td> <!-- ScandiQA-no -->
   <td class="sv ner">4.65 ± 2.41 / 4.95 ± 2.84</td> <!-- SUC3 -->
   <td class="sv sent">79.99 ± 1.39 / 80.50 ± 1.29</td> <!-- SweReC -->
   <td class="sv la">10.80 ± 3.37 / 50.62 ± 4.55</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 19.60 ± 1.24</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="speed">1,818 ± 482 / 339 ± 114</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="la-score"></td> <!-- Mean linguistic acceptability score -->
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">1.28 ± 1.47 / 1.75 ± 2.00</td> <!-- DaNE -->
   <td class="da sent">39.90 ± 2.65 / 56.82 ± 3.23</td> <!-- Angry Tweets -->
   <td class="da la">10.78 ± 2.64 / 40.21 ± 3.03</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 8.83 ± 1.75</td> <!-- ScandiQA-da -->
   <td class="no ner">4.63 ± 3.70 / 4.97 ± 3.89</td> <!-- NorNE-nb -->
   <td class="no ner">4.63 ± 3.70 / 4.97 ± 3.89</td> <!-- NorNE-nn -->
   <td class="no sent">39.25 ± 1.79 / 57.15 ± 1.16</td> <!-- NoReC -->
   <td class="no la">8.77 ± 1.23 / 45.88 ± 3.96</td> <!-- ScaLA-nb -->
   <td class="no la">8.77 ± 1.23 / 45.88 ± 3.96</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 10.28 ± 1.39</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">69.23 ± 3.61 / 73.11 ± 2.70</td> <!-- SweReC -->
   <td class="sv la">9.03 ± 2.57 / 38.48 ± 2.28</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.05 ± 0.03 / 14.21 ± 2.33</td> <!-- ScandiQA-sv -->
  </tr>
  <tr>
   <td class="rank"></td> <!-- Rank -->
   ...
   <td class="vocabulary_size">32</td> <!-- Size of the model's vocabulary -->
   <td class="max_sequence_length">32768</td> <!-- Maximum sequence length of the model-->
   <td class="speed">1,918 ± 500 / 345 ± 116</td> <!-- Model inference speed -->
   <td class="score"></td> <!-- ScandEval score -->
   <td class="da-score"></td> <!-- Danish score -->
   <td class="no-score"></td> <!-- Norwegian score -->
   <td class="sv-score"></td> <!-- Swedish score -->
   ...
   <td class="qa-score"></td> <!-- Mean question answering score -->
   <td class="da ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- DaNE -->
   <td class="da sent">47.64 ± 1.97 / 62.67 ± 2.89</td> <!-- Angry Tweets -->
   <td class="da la">4.15 ± 2.92 / 46.16 ± 4.00</td> <!-- ScaLA-da -->
   <td class="da qa">0.00 ± 0.00 / 15.11 ± 2.20</td> <!-- ScandiQA-da -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nb -->
   <td class="no ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- NorNE-nn -->
   <td class="no sent">42.36 ± 5.31 / 59.33 ± 5.32</td> <!-- NoReC -->
   <td class="no la">6.80 ± 1.88 / 44.35 ± 4.08</td> <!-- ScaLA-nb -->
   <td class="no la">6.80 ± 1.88 / 44.35 ± 4.08</td> <!-- ScaLA-nn -->
   <td class="no qa">0.00 ± 0.00 / 17.25 ± 1.91</td> <!-- ScandiQA-no -->
   <td class="sv ner">0.00 ± 0.00 / 0.00 ± 0.00</td> <!-- SUC3 -->
   <td class="sv sent">78.12 ± 1.08 / 78.28 ± 1.09</td> <!-- SweReC -->
   <td class="sv la">2.19 ± 1.88 / 39.68 ± 3.18</td> <!-- ScaLA-sv -->
   <td class="sv qa">0.00 ± 0.00 / 19.20 ± 1.61</td> <!-- ScandiQA-sv -->
  </tr>
 </tbody>
</table>
</div>