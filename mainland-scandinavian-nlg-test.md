...
<center>Last updated: 11/03/2024 14:21:55 CET</center>
...
&nbsp;&nbsp;&bull;&nbsp;&nbsp;
<p onclick="addToClipboard('<iframe title="Mainland Scandinavian NLG" aria-label="Table" id="datawrapper-chart-6BQ5T" src="https://datawrapper.dwcdn.net/6BQ5T/6/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();
</script>')">Embed</p>
</div>
