   ...
   <th id="rank-col"><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="The average number of standard deviations away from the best model">Distance from SOTA</span></th>
    ...
    if len(language_mapping) > 1:
        for language_code, language_name in language_mapping.items():
            ...
            BENCHMARK_HTML_START += f"""
   <th><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="The average number of standard deviations away from the best model on {language_name_title} tasks">{language_name_title}</span></th>"""
