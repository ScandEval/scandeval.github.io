"""Python script to generate the Mainland Scandinavian NLG leaderboard."""
...
layout: leaderboard
title: Mainland Scandinavian NLG Benchmark
---
...
<table id="mainland-scandinavian-nlg-benchmark" class="sortable fixed centered small-font">
 <thead>
  <tr>
   ...
   <th><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="Total summarization score - Macro-average across languages">SUMM</span></th>
   ...
   <th><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="Danish summarization - Exact match / F1-score">NordjyllandNews</span></th>
   ...
   <th><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="Norwegian summarization- Exact match / F1-score">NoSammendrag</span></th>
   ...
   <th><span data-toggle="tooltip" data-placement="bottom" data-container="body" title="Swedish summarization - Exact match / F1-score">SweDN</span></th>
  </tr>
 </thead>
 <tbody>"""
...
BENCHMARK_ENTRY = """  <tr>
   ...
   <td class="summ-score"></td> <!-- Mean summarization score -->
   ...
   <td class="da summ">{da_summ}</td> <!-- NordjyllandNews -->
   ...
   <td class="no summ">{no_summ}</td> <!-- NoSammendrag -->
   ...
   <td class="sv summ">{sv_summ}</td> <!-- SweDN -->
  </tr>"""


# Set up primary/secondary metrics
PRIMARY_METRICS = ["mcc", "em", "micro_f1", "bertscore", "speed"]
SECONDARY_METRICS = ["macro_f1", "f1", "micro_f1_no_misc", "rouge_l", "speed_short"]
...
def main() -> None:
    ...
    benchmark_path = Path("mainland-scandinavian-nlg-benchmark.md")
    ...
    for model_id, model_dict in model_scores.items():
        values = dict(
            ...
            da_summ=model_dict.get("da summ", ""),
    ...
    # Log status
    logging.info(
        "Generated Mainland Scandinavian NLG benchmark with results from "
